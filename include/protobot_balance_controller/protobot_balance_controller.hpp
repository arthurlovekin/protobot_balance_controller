...
#include "protobot_balance_controller/protobot_balance_controller_parameters.hpp"
...
class ProtobotBalanceController : public controller_interface::ChainableControllerInterface
{
  ...
  protected:
    ...
    // and this node should just get the new tf frames instead of imu)
    std::shared_ptr<tf2_ros::Buffer> tf_buffer_;

    geometry_msgs::msg::TransformStamped pendulum_wrt_imu_frame_;
    tf2::Quaternion pendulum_wrt_imu_quat_;
